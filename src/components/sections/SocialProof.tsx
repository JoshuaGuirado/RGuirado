        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24 max-w-4xl mx-auto">
          {stats.map((stat, idx) => (
            ...
            >
              ...
              <h3 className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-gold-600 mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
          {testimonials.map((t, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-dark-800/40 backdrop-blur-md border border-white/5 hover:border-gold-500/20 rounded-[2.5rem] p-8 flex flex-col justify-between shadow-xl transition-all"
            >
